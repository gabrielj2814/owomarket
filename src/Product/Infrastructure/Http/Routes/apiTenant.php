...
use Src\Product\Infrastructure\Http\Controller\ToggleProductMarketplacePublicationPOSTController;
...
Route::post('/{id}/toggle-marketplace', ToggleProductMarketplacePublicationPOSTController::class);
