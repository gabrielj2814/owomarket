...
use Src\CentralMarketplace\Infrastructure\Http\Controller\QuoteCentralOrderPOSTController;
...
Route::post('/checkout/quote', QuoteCentralOrderPOSTController::class);
