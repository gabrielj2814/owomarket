...
const TaxIndexPage: FC<TaxIndexPageProps> = ({ user_id, title, host, user_name }) => {
    ...
    const fetchTaxRates = async (page = currentPage) => {
        setLoading(true);
        try {
            const res = await TaxServices.filtrar(
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight flex items-center gap-2">
                            <HiReceiptTax className="w-8 h-8 text-emerald-600 dark:text-emerald-400" />
                        ...
                        <Table hoverable>
                            ...
                            <TableBody className="divide-y divide-gray-100 dark:divide-gray-700">
                                {loading ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={5} className="text-center py-12">
                                            <HiReceiptTax className="w-12 h-12 mx-auto text-gray-300 dark:text-gray-600 mb-2" />
