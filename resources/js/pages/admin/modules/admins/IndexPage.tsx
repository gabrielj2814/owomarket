...
const IndexPage: FC<IndexPageProps> = ({ title = "Nuevo Modulo OwOMarket", user_id, type=null, message=null, titleToast=null }) => {
    ...
    const irHaFormularioDeCrear = () => {
        setStateLodaer(true)
        window.location.href=`/admin/backoffice/${user_id}/module/record`
    }
    ...
    const eliminar = async () => {
        ...
        const respuestaApi = await AdminServices.delete(uuidAdminDelete)
    ...
    return (
        <>
            ...
            <Dashboard user_uuid={user_id}>
                ...
                <div className={`overflow-scroll overflow-x-hidden overflow-y-auto`} style={{ height: "calc(100vh - 440px)" }}>
