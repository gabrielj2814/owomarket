...
3. **Ubicación y Estructura de Planes (`planes/`)**:
   Todos los planes de trabajo maestros, especificaciones, notas y hojas de ruta deben residir exclusivamente dentro del directorio `planes/`, organizados estrictamente en las siguientes 4 subcarpetas:
